//
//  ViewControllerUsageMonth.swift
//  Hems
//
...
class ViewControllerUsageMonth: CustomUIViewController {
    ...
    override func viewDidLoad() {
        ...
        getUsageListMonthly(nYear, nMonth, false)
    }
    ...
    */
    ...
    func getUsageListMonthly(_ nYear: Int, _ nMonth: Int, _ bShowWaitDialog: Bool) {
        let nEnergyType = CaApp.m_Info.m_EnergyManager.m_nActiveIndex
        switch (nEnergyType) {
        case 0:
            CaApp.m_Engine.GetUsageListMonthlyElec(CaApp.m_Info.nSeqAptHo, nYear, nMonth, bShowWaitDialog, self)

        case 1:
            CaApp.m_Engine.GetUsageListMonthlyWater(CaApp.m_Info.nSeqAptHo, nYear, nMonth, bShowWaitDialog, self)
            
        case 2:
            CaApp.m_Engine.GetUsageListMonthlyGas(CaApp.m_Info.nSeqAptHo, nYear, nMonth, bShowWaitDialog, self)
            
        case 3:
            CaApp.m_Engine.GetUsageListMonthlyHeat(CaApp.m_Info.nSeqAptHo, nYear, nMonth, bShowWaitDialog, self)
            
        case 4:
            CaApp.m_Engine.GetUsageListMonthlySteam(CaApp.m_Info.nSeqAptHo, nYear, nMonth, bShowWaitDialog, self)
    ...
    @objc func datePickerDone(){
        ...
        getUsageListMonthly(nYear, nMonth, true)
    }
    ...
    override func onResult(_ Result: CaResult) {
        ...
        case CaApp.m_Engine.API_GET_USAGE_LIST_MONTHLY_ELEC,
             CaApp.m_Engine.API_GET_USAGE_LIST_MONTHLY_WATER,
             CaApp.m_Engine.API_GET_USAGE_LIST_MONTHLY_GAS,
             CaApp.m_Engine.API_GET_USAGE_LIST_MONTHLY_HEAT,
             CaApp.m_Engine.API_GET_USAGE_LIST_MONTHLY_STEAM:
    ...
    func fillChart() {
        ...
        // ValueFormatter Date 개수에 맞게 변경
        switch m_dataArray.count {
            case 28:
            ...
            default:
                print("Chart: default!")
                print("dataArray length is" + String(m_dataArray.count))
        }
        ...
        m_Chart.xAxis.setLabelCount(m_dataArray.count, force: true)
        ...
        // X축 간격
        m_Chart.xAxis.granularity = m_Chart.xAxis.axisMaximum / Double(m_dataArray.count)
        m_Chart.xAxis.granularityEnabled = true
        m_Chart.xAxis.labelCount = m_dataArray.count
        // X축 Label
       // m_Chart.xAxis.valueFormatter = formatter

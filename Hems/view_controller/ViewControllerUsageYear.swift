...
class ViewControllerUsageYear: CustomUIViewController {
    ...
    override func viewDidLoad() {
        ...
        textDate.text = CaApp.m_Info.dfyyyy.string(from: date)
        
        let nYear = cal.component(.year, from: date)

        getUsageListYearly(nYear, false)
    }
    ...
    */
    ...
    func getUsageListYearly(_ nYear: Int, _ bShowWaitDialog: Bool) {
        let nEnergyType = CaApp.m_Info.m_EnergyManager.m_nActiveIndex
        switch (nEnergyType) {
        case 0:
            CaApp.m_Engine.GetUsageListYearlyElec(CaApp.m_Info.nSeqAptHo, nYear, bShowWaitDialog, self)

        case 1:
            CaApp.m_Engine.GetUsageListYearlyWater(CaApp.m_Info.nSeqAptHo, nYear, bShowWaitDialog, self)
            
        case 2:
            CaApp.m_Engine.GetUsageListYearlyGas(CaApp.m_Info.nSeqAptHo, nYear, bShowWaitDialog, self)
            
        case 3:
            CaApp.m_Engine.GetUsageListYearlyHeat(CaApp.m_Info.nSeqAptHo, nYear, bShowWaitDialog, self)
            
        case 4:
            CaApp.m_Engine.GetUsageListYearlySteam(CaApp.m_Info.nSeqAptHo, nYear, bShowWaitDialog, self)
    ...
    @objc func datePickerDone(){
        ...
        textDate.text = CaApp.m_Info.dfyyyy.string(from: m_DatePicker.date)
    ...
    override func onResult(_ Result: CaResult) {
        ...
        case CaApp.m_Engine.API_GET_USAGE_LIST_YEARLY_ELEC,
             CaApp.m_Engine.API_GET_USAGE_LIST_YEARLY_WATER,
             CaApp.m_Engine.API_GET_USAGE_LIST_YEARLY_GAS,
             CaApp.m_Engine.API_GET_USAGE_LIST_YEARLY_HEAT,
             CaApp.m_Engine.API_GET_USAGE_LIST_YEARLY_STEAM:
    ...
    func fillChart() {
        ...
        // x축 label
        let formatter:YearlyChartFormatter = YearlyChartFormatter()
